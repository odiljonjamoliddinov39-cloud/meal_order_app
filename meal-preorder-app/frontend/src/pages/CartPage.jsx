...
const labels = {
  ...
  RUS: {
    ...
    ordered: 'Заказ успешно оформлен',
    failed: 'Не удалось оформить заказ',
    authRequired: 'Откройте меню через Telegram перед заказом',
    cartMismatch: 'В корзине данные разных дней или ошибка. Добавьте позиции заново.',
